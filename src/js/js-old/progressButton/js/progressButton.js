...
(function(window, $) {
    ...
    ProgressButton.prototype.fv = function() {
        return $('#contactForm').data('formValidation');
    }

    ProgressButton.prototype.doAnimation = function() {

    }

    ProgressButton.prototype._initEvents = function() {
        var self = this,
            formInstance = self.fv();
        var clickListener = function() {
            var formInstance = self.fv();
            // console.log('clicked', formInstance);
            for (var key in formInstance._cacheFields) {
                // console.log(formInstance._cacheFields[key][0]);
                formInstance._cacheFields[key][0].addEventListener('keypress', function(e) {
                    if (e.keyCode === 13) {
                        e.preventDefault();
                        var formInstance = self.fv();
                        // console.log('clicked', formInstance);
    ...
    ProgressButton.prototype._stop = function(status) {
        ...
        setTimeout(function() {
            ...
            // clear the form
            // console.log(formInstance._cacheFields);
